...
def open_file():
    ...
    #if a file is opened then display the contents of file
    with open(filepath, "r") as input_file:
        text = input_file.read() #Read contents of the input file

        txt_edit.insert(END, text) # Insert contentsof the file in the editor box
...
def save_file():
    # Sve the current file as a new file
